...
export const webRouterApi = (app: Express) => {
  ...
  router.post(
    ...
    authenticate,
    isJobSeeker,
    companyController.createReview,
  );
  ...
  router.put(
    ...
    authenticate,
    isAdmin,
    jobController.updateJobAdmin,
  );
  router.delete(
    "/admin/jobs/:id",
    authenticate,
    isAdmin,
    jobController.deleteJobAdmin,
  );
  ...
  router.get(
    ...
    authenticate,
    isHR,
    applicationController.searchCandidates,
  );
  ...
  router.get(
    ...
    authenticate,
    isAdmin,
    emailController.getAllContacts,
  );
  router.put(
    "/admin/contacts/:id/resolve",
    authenticate,
    isAdmin,
    emailController.resolveContact,
  );
